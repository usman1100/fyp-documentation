\setcounter{figure}{0}
\subsubsection{Use Case-01: Register}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-02: Login}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-03: OAuth}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-04: Logout}
    \begin{figure}[H]
    ...
    \begin{center}
        \begin{tabularx}{\textwidth}{|l|X|}
            ...
            \textbf{Name} & Logout \\
            \hline
            \textbf{Description} & A pop-up window is appeared for the verification of logout their ID \\
            \hline
            \textbf{Actors} & Account Holder \\
            \hline
            \textbf{Triggers} & Just a confirmation delay of 5 sec and it logout after that automatically \\
            \hline
            \textbf{Pre Conditions} & Login the account first \\
            \hline
            \textbf{Post Conditions} & Logout Succesfully \\
            \hline
            \textbf{Main Course} & User can logout anytime and anywhere to avoid unexpected inputs Use Caseom their account \\
            \hline
            \textbf{Alternative Course} & Error will be show \\
            \hline
    ...
    \subsubsection{Use Case-05: Forget Password}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-06: Reset Password}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-07: Confirm Account}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-08: Delete Account}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-09: Edit Account Info}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-10: Edit Interface Preferences}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-11: Create Project}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-12: Edit Project}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-13: Delete Project}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-14: Add Developer}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-15: Remove Developer}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-16: Edit Developer Permission}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-17: Calculate UCP}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-18: Get Machine Learning Estimation}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-19: Manual Estimate Round}
    \begin{figure}[H]
    ...
    \subsubsection{Use Case-20: Estimation Bar}
    \begin{figure}[H]
